        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                id: "flashcards-rating",
                class: "flashcards-rating",
                hidden: true,
                children: [
                  /* @__PURE__ */ jsxs("p", {
                    children: [
                      /* @__PURE__ */ jsx("strong", { children: "How did you do?" }),
                      " Grade your own recall.",
                    ],
                  }),
                  /* @__PURE__ */ jsxs("div", {
                    class: "flashcards-rating-actions",
                    children: [
                      /* @__PURE__ */ jsxs("button", {
                        type: "button",
                        "data-rating": "incorrect",
                        class: "flashcards-rating-button",
                        children: ["Incorrect ", /* @__PURE__ */ jsx("small", { children: "0" })],
                      }),
                      /* @__PURE__ */ jsxs("button", {
                        type: "button",
                        "data-rating": "partial",
                        class: "flashcards-rating-button",
                        children: ["Partial ", /* @__PURE__ */ jsx("small", { children: "0.5" })],
                      }),
                      /* @__PURE__ */ jsxs("button", {
                        type: "button",
                        "data-rating": "correct",
                        class: "flashcards-rating-button",
                        children: ["Correct ", /* @__PURE__ */ jsx("small", { children: "1" })],
                      }),
                      /* @__PURE__ */ jsxs("button", {
                        type: "button",
                        "data-rating": "easy",
                        class: "flashcards-rating-button",
                        children: ["Easy ", /* @__PURE__ */ jsx("small", { children: "1" })],
                      }),
                    ],
                  }),
                ],
...
(() => {
  ...
  const render = () => {
    ...
    byId("flashcards-list").innerHTML = personal.length
      ? personal.map((card, index) => '<article class="flashcard-item"><div><strong>' + escapeHtml(card.term) + '</strong>' + (card.queued ? ' <span class="flashcard-queued">Next quiz</span>' : '') + '<p>' + escapeHtml(card.definition) + '</p><small>' + escapeHtml((card.tags || []).join(" \xB7 ")) + '</small></div><button type="button" data-remove-card="' + index + '" aria-label="Remove ' + escapeHtml(card.term) + '">Remove</button></article>').join("")
    ...
    byId("flashcards-history-summary").textContent = attempts
      ? attempts + " quizzes \xB7 " + latest + "% latest \xB7 " + average + "% average \xB7 " + best + "% best \xB7 " + (change >= 0 ? "+" : "") + change + " pts"
      : "No quiz history yet"
    renderTopics()
  }
  const finishQuiz = () => {
